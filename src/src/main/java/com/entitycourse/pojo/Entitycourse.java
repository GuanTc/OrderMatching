...
public class Entitycourse {
    ...
    private String entutycoursePlace;

    private Long entitycoursePid;

    private Long entitycourseCid;
    ...
    public String getEntutycoursePlace() {
        return entutycoursePlace;
    }

    public void setEntutycoursePlace(String entutycoursePlace) {
        this.entutycoursePlace = entutycoursePlace == null ? null : entutycoursePlace.trim();
    }

    public Long getEntitycoursePid() {
        return entitycoursePid;
    }

    public void setEntitycoursePid(Long entitycoursePid) {
        this.entitycoursePid = entitycoursePid;
    }

    public Long getEntitycourseCid() {
        return entitycourseCid;
    }

    public void setEntitycourseCid(Long entitycourseCid) {
        this.entitycourseCid = entitycourseCid;
    }
